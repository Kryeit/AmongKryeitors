    ...
    public void GameStartUp() {
        ...
        for(UUID element : PlayersInGame) {
            if (AmongKryeitors.crewmates.contains(element)) {
                ...
                Bukkit.getPlayer(element).getInventory().setItem(4, filler);
                ...
                Bukkit.getPlayer(element).getInventory().setItem(1, imp_actions);

                ItemStack filler = new ItemStack(Material.GRAY_STAINED_GLASS_PANE);
                Bukkit.getPlayer(element).getInventory().setItem(2, filler);
                ...
                Bukkit.getPlayer(element).getInventory().setItem(2, shapeshift);

                ItemStack filler = new ItemStack(Material.GRAY_STAINED_GLASS_PANE);
                Bukkit.getPlayer(element).getInventory().setItem(3, filler);
            }
        }
