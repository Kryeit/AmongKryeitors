    ...
    public void GameStartUp() {
        ...
        for(UUID element : PlayersInGame) {
            if (AmongKryeitors.crewmates.contains(element)) {
                ...
                Bukkit.getPlayer(element).getInventory().setItem(3, imp_actions);

                Bukkit.getPlayer(element).getInventory().setItem(2, report_body);
                ...
                Bukkit.getPlayer(element).getInventory().setItem(4, shapeshift);
